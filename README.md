...
Кастомная нода для **ComfyUI**, которая автоматически генерирует случайные промпты для генерации изображений с помощью локальных LLM моделей через **Ollama**. Нода подготавливает готовые **conditioning** для моделей Flux, Z-image, Krea2 и тд. экономя время на ручном создании промптов и расширяя творческие возможности. Специальная оптимизация для **Qwen 3.5** с автоматическим отключением режима мышления.
...
<img width="1934" height="1186" alt="2026-07-01_17-16-18" src="https://github.com/user-attachments/assets/d1e56d35-2f78-416e-a247-4d3109df9093" />
